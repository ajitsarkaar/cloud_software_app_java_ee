...
('Domaine Aubron Muscadet “Cuvee Elegance”', '2016', 'France ', 'When it comes to food-friendly white wines, you can’t do much better than Muscadet. Fresh aromas of peach and lemon with a minerally, citrusy character on the palate. Crisp acidity makes this more than a match for seafood—try it with the smoked oysters!', 9,36, 'White' ),
...
('Peachy Canyon ''Incredible Red'' Zinfandel ', '2015','USA', 'Rich and fruit-forward, this wine begins with a subtle smoky nose full of cedar, cigar box and candied red cherry….then burst on the palate with bright strawberry and over-ripe cherry fruit flavors, with hints of mocha and leather mixed in for a full-bodied wine.', 9.5,38, 'Red'),
('Mas Olivier “Grand Reserve”', '2015', 'France', 'Syrah, Carignan, Grenache blend. Soft aromas of red/black berries, plum, subtle spice and pepper, and hints of coffee. Medium to full bodied wine with solid tannins and fruit and a kiss of caramelized oak on the finish.', 6,24,'Red'),
...
('Lambrusco Grasparossa di Castelvetro "Becco Rosso"',null, 'Italy', 'Wow. Love the Lambrusco: a fizzy red wine! Opens with intense floral, violet & red berry scents. The palate delivers the fruit, tangy acidity, and even a hint of sea salt. Brilliant charcuterie pairing.',10,40,'Red'),
...
('Brancatelli Valle D. Stelle “Super Tuscan”','2015','Italy', ' A great 75% Cabernet Sauvignon and 25% Cabernet Franc blend from Tuscany! Rich raspberry and cherry, medium to full body, bright fine tannins and a fresh and silky finish.', 13,52, 'Red'),
...
('Mollydooker “The Boxer”', '2017', 'Australia', ' This extracted Shiraz is unabashedly in-your-face. The aroma is full of spiced plums, blackberry jam and black cherry. Flavors of licorice, vanilla and dark berries combined with hints of coffee and chocolate on the finish. Rich, tannic, and full-bodied, it’s a wine you won’t forget anytime soon.',22,66,'Red');
